...
There is a strong overall correlation between GDP per capita and healthcare scores. Notably, *no* country in the dataset had a high healthcare score alongside low GDP, which is consistent with the intuition that financial resources underpin healthcare capacity.
